define(function (require, exports, module) {
    ...
    var formInit = require('component/pcframe/form');
    ...
    var initPage = function (model, flowId) {
        ...
        try {
            ...
            formView.setAttribute('paramters', model.form.paramters);
        ...
        $('.header, .content-form-pc, .footer').show();
